...
import webLoadTest.utilities.Keywords;
...
public class TestBasePerformanceBrowser {
    ...
    public static String geckoDriverPath  = currentDirectory + "/lib/geckoDriver/geckodriver";
